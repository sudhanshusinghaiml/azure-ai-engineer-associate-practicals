...
def analyze_all_image_file():
    ...
    try:
        load_dotenv()
        endpoint = os.environ["AIVISION_ENDPOINT"]
        key = os.environ["AIVISION_API_KEY"]
    except KeyError:
    ...
    with open("SampleCodes/vision/sample.jpg", "rb") as f:
        image_data = f.read()
