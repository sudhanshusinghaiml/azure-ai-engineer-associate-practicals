...
def main():
    ...
    try:
        ...
        chat_model = os.getenv("MODEL_DEPLOYMENT")
        embedding_model = os.getenv("EMBEDDING_MODEL_DEPLOYMENT")
        search_url = os.getenv("AZURE_AISEARCH_ENDPOINT")
        ...
        print(f"AzureOpenAI client initialized.")
